...
export default function Home() {
  ...
  const addTransaction = async()=> {
    ...
    try {
      ...
      console.error("Erreur ajout de transaction", error);
      toast.error("Erreur ajout de transaction")
    }finally {
      setLoading(false)
    }
  }
      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box border-2 border-warning/10 border-dashed">
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="flex flex-col gap-2">
              <label className="label">Montant (négatif - dépense, postifi - revenu)</label>
              <input 
                type="number"
                name="amount"
                value={amount}
